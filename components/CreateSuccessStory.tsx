...
const CreateSuccessStory = () => {
  return (
    <div className='   pb-12 md:pb-24 container'>
      <Section>
        <div className='bg-[#b9ff66] mt-24 w-full p-8 sm:px-14 h-auto sm:h-[280px] rounded-[45px] inline-flex flex-col sm:flex-row justify-start items-center gap-8 sm:gap-10'>
